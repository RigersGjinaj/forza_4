while (!player1){
    var player1 = prompt('Player Uno:');
};
var player1Color = 'red';

while (!player2){
    var player2 = prompt('Player Due');
};
...
var currentPlayer = 1;
let winner;
playerTurn.textContent = `Turno di ${player1}`
        ...
        if (tableRow[i].children[column].style.backgroundColor == 'white'){
            ...
            if (currentPlayer === 1){
                ...
                if (horizontalCheck() || verticalCheck() || diagonalCheck() || diagonalCheck2()){
                    ...
                    playerTurn.textContent = `Turno di ${player2}`;
...
resetBtn.addEventListener('click', () => {
    ...
    return (currentPlayer === 1 ? playerTurn.textContent = `Turno di ${player1}` : playerTurn.textContent = `Turno di ${player2}`);
})